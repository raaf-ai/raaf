...
# Add DSL gem path for testing
dsl_lib_path = File.expand_path("../../../dsl/lib", __dir__)
$LOAD_PATH.unshift(dsl_lib_path) unless $LOAD_PATH.include?(dsl_lib_path)
...
RSpec.describe "Agent Span Management Integration", type: :unit do
  ...
  class TestAgent < RAAF::DSL::Agent
    ...
    def run_without_timeout(**options)
      parent_component = options[:parent_component] || @parent_component
