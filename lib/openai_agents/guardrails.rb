...
module OpenAIAgents
  ...
  #   custom_guardrail = OpenAIAgents::Guardrails.create_input_guardrail(
  #     name: "business_hours",
  #     validate: ->(context, agent, input) {
  #       if Time.now.hour < 9 || Time.now.hour > 17
  #         OpenAIAgents::Guardrails::GuardrailResult.new(
  #           safe: false,
  #           flagged: true,
  #           explanation: "Support is only available 9 AM - 5 PM"
  #         )
  #       else
  #         OpenAIAgents::Guardrails::GuardrailResult.new(safe: true)
  #       end
  #     }
  #   )
  #
