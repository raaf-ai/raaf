...
module OpenAIAgents
  ...
  #   # Run asynchronously
  #   Async do
  #     result = OpenAIAgents::Async.run(agent, "Hello world").wait
  ...
  #     tasks = [
  #       Async { OpenAIAgents::Async.run(agent1, "Task 1") },
  #       Async { OpenAIAgents::Async.run(agent2, "Task 2") },
  #       Async { OpenAIAgents::Async.run(agent3, "Task 3") }
  #     ]
  #     
  ...
  module Async
    ...
    #
    # @example
    #   runner = OpenAIAgents::Async.runner(
    #     agent: agent,
    #     max_turns: 5,
    #     timeout: 30
    #   )
    ...
    #   task = OpenAIAgents::Async.run(agent, "Hello")
    #   result = task.wait  # Blocks until completion
    #
    # @example With configuration
    #   task = OpenAIAgents::Async.run(
    #     agent, 
    #     "Complex query",
    #     max_turns: 3,
    #     temperature: 0.7
