...
#   class MyRunHooks < OpenAIAgents::RunHooks
...
#   config = OpenAIAgents::RunConfig.new(hooks: MyRunHooks.new)
#   runner.run(messages, config: config)
#
# @example Agent-specific hooks
#   class CustomerServiceHooks < OpenAIAgents::AgentHooks
...
#
#   composite = OpenAIAgents::CompositeRunHooks.new([logging_hooks, metrics_hooks])
#   composite.add_hook(audit_hooks)
#
#   config = OpenAIAgents::RunConfig.new(hooks: composite)
#
# @author OpenAI Agents Ruby Team
# @since 0.1.0
# @see OpenAIAgents::RunContext For context object passed to hooks
# @see OpenAIAgents::Agent For agent-level hook configuration
module OpenAIAgents
  ##
  ...
  #   class PerformanceHooks < OpenAIAgents::RunHooks
  #     def on_agent_start(context, agent)
  ...
  #   class SecureAgentHooks < OpenAIAgents::AgentHooks
  ...
  #   composite = OpenAIAgents::CompositeRunHooks.new
  ...
  #   class AsyncLoggingHooks < OpenAIAgents::AsyncHooks::RunHooks
  ...
  #   class HybridHooks < OpenAIAgents::AsyncHooks::RunHooks
  #     def on_agent_start(context, agent)
