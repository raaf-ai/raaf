...
module OpenAIAgents
  ##
  # Refactored configuration for a single run of an agent
  #
  ...
  #
  # @example Basic usage
  #   config = RunConfigV2.new(max_turns: 10, temperature: 0.7)
  ...
  #   config = RunConfigV2.new(model: model_config, tracing: tracing_config)
  #
  class RunConfigV2
    ...
    ##
    # Merge with another RunConfigV2
    #
    # @param other [RunConfigV2] Config to merge
    # @return [RunConfigV2] New merged config
    #
    def merge(other)
    ...
    # @return [RunConfigV2] New config with replaced components
    #
