...
module OpenAIAgents
  ...
  #   OpenAIAgents::HashUtils.prepare_for_openai({key: "value", nested: {inner: 123}})
  #   # => {"key" => "value", "nested" => {"inner" => 123}}
  #
  # @example Response normalization  
  #   api_response = {"message" => {"role" => "assistant", "content" => "Hello"}}
  #   OpenAIAgents::HashUtils.normalize_response(api_response)
  ...
  #     ]
  #   }
  #   OpenAIAgents::HashUtils.prepare_for_openai(data)
  #   # => {"messages" => [{"role" => "user", "content" => "Hi"}, ...]}
  #
  # @example Schema preparation for strict mode
  #   schema = {type: "object", properties: {name: {type: "string"}}}
  #   OpenAIAgents::HashUtils.prepare_schema_for_openai(schema)
  #   # => {"type" => "object", "properties" => {"name" => {"type" => "string"}}}
  #
  # @author OpenAI Agents Ruby Team
  # @since 0.1.0
  # @see OpenAIAgents::StrictSchema For schema validation utilities
  module HashUtils
    module_function
    ...
    #
    # @see OpenAIAgents::StrictSchema.ensure_strict_json_schema For schema validation details
