...
module OpenAIAgents
  ...
  #   store = OpenAIAgents::Memory.create_store(:in_memory)
  ...
  #   store = OpenAIAgents::Memory.create_store(
  #     :file,
  ...
  #   OpenAIAgents::Memory.default_store = OpenAIAgents::Memory.create_store(
  #     :file,
  #     base_dir: "./shared_memory"
  #   )
  #
  # @example Creating a custom store
  #   class RedisStore < OpenAIAgents::Memory::BaseStore
