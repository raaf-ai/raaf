...
module RubyAIAgentsFactory
  ...
  #   visualizer = RubyAIAgentsFactory::Visualization::TraceVisualizer.new(spans)
  #   puts visualizer.render_ascii
  #   puts visualizer.render_timeline
  #
  # @example HTML report generation
  #   html_report = RubyAIAgentsFactory::Visualization::HTMLVisualizer.generate(spans)
  #   File.write("trace_report.html", html_report)
  #
  # @example Workflow visualization
  #   workflow_viz = RubyAIAgentsFactory::Visualization::WorkflowVisualizer.new(agents)
  ...
  #   chart = RubyAIAgentsFactory::Visualization::MetricsChart.generate_performance_chart(performance_data)
  #   puts chart
  #
  # @author OpenAI Agents Ruby Team
  # @since 0.1.0
  # @see RubyAIAgentsFactory::Tracing::SpanTracer For trace data collection
  module Visualization
    ...
    # @author OpenAI Agents Ruby Team
    # @since 0.1.0
    # @see RubyAIAgentsFactory::Agent For agent configuration
