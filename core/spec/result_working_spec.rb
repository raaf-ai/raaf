...
RSpec.describe RAAF::AgentResult do
  describe "#initialize" do
  ...
  describe "#total_tool_calls" do
    it "returns tool call count" do
      tool_calls = ["search", "calculate", "format"]
  ...
  describe "#to_h" do
    it "includes agent-specific fields and stats" do
      ...
      expect(hash[:tool_calls]).to eq(["tool1", "tool2"])
...
RSpec.describe RAAF::ToolResult do
  describe "#initialize" do
...
RSpec.describe RAAF::StreamingResult do
  describe "#initialize" do
...
RSpec.describe RAAF::HandoffResult do
  describe "#initialize" do
...
RSpec.describe RAAF::ValidationResult do
  describe "#initialize" do
...
RSpec.describe RAAF::BatchResult do
  describe "#initialize" do
...
RSpec.describe RAAF::RunResult do
  ...
  describe "#initialize" do
    it "creates run result with all parameters" do
      ...
      tool_results = ["search_result", "calc_result"]
...
RSpec.describe RAAF::ResultBuilder do
  describe "#initialize" do
