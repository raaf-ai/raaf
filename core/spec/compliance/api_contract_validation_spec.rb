  ...
  describe "OpenAI Responses API Contract" do
        ...
        properties: {
          ...
          input: {
            ...
            items: {
              ...
              properties: {
                role: { type: "string", enum: %w[system user assistant tool] },
                content: { type: "string" },
                name: { type: "string" },
    ...
    let(:response_schema) do
      {
        ...
        properties: {
            ...
            items: {
              oneOf: [
                ...
                },
                {
                  ...
                  type: "object",
                  required: %w[type name arguments],
                  properties: {
          ...
          usage: {
            type: "object",
            required: %w[input_tokens output_tokens],
            properties: {
    ...
    it "validates tool definitions in requests" do
      tool = RAAF::FunctionTool.new(
        proc { |location:, _unit: "celsius"| "Weather in #{location}" },
        name: "get_weather",
