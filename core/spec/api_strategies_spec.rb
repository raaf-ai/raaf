...
RSpec.describe RAAF::Execution::BaseApiStrategy do
...
RSpec.describe RAAF::Execution::ResponsesApiStrategy do
...
RSpec.describe RAAF::Execution::StandardApiStrategy do
  let(:provider) { double("Provider") }
...
RSpec.describe RAAF::Execution::ApiStrategyFactory do
