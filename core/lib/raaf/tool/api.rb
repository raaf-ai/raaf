  ...
  class Tool
    ...
    class API < Tool
      ...
      class << self
        ...
        attr_accessor :api_endpoint, :api_method, :api_headers, :api_timeout, :api_key_value, :api_key_env_var, :retry_count, :retry_delay_value
      ...
      def api_key
        @api_key_override ||
          ...
          (self.class.api_key_env_var && ENV.fetch(self.class.api_key_env_var, nil))
      end
