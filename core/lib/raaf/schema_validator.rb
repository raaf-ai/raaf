  ...
  class SchemaValidator
    ...
    def validate_strict(data)
      ...
      required_fields.each do |field_name|
        ...
        next unless data[field_key].nil? && data[field_name.to_s].nil?
      ...
      data.each do |key, value|
        ...
        if field_schema
          if type_matches_strict?(value, field_schema[:type])
    ...
    def validate_tolerant(data, attempt)
      ...
      properties.each do |field_name, field_schema|
        ...
        next unless field_schema[:default]
      ...
      if !result[:valid] && attempt < @repair_attempts
        ...
        return validate(repaired_data, attempt: attempt + 1) if repaired_data != data
      end
