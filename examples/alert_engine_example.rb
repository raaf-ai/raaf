...
alert_engine.add_handler(:console, OpenAIAgents::Tracing::AlertHandlers::Console.new)
alert_engine.add_handler(:slack, OpenAIAgents::Tracing::AlertHandlers::Slack.new(
