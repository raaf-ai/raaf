...
# the OpenAI Agents Ruby gem. The visualization system provides:
#
...
trace_visualizer = OpenAIAgents::Visualization::TraceVisualizer.new(sample_workflow[:spans])
...
workflow_visualizer = OpenAIAgents::Visualization::WorkflowVisualizer.new(sample_workflow[:agents])
...
performance_chart = OpenAIAgents::Visualization::MetricsChart.generate_performance_chart(performance_chart_data)
...
usage_chart = OpenAIAgents::Visualization::MetricsChart.generate_usage_chart(tool_usage_data)
puts usage_chart
...
html_content = OpenAIAgents::Visualization::HTMLVisualizer.generate(sample_workflow[:spans])
...
config_info = {
  ...
  html_visualizer: "OpenAIAgents::Visualization::HTMLVisualizer",
  metrics_chart: "OpenAIAgents::Visualization::MetricsChart",
