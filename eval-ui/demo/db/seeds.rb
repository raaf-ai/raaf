...
agents = %w[TestAgent ResearchAgent WriterAgent AnalyzerAgent SupportAgent]
models = ["gpt-4o", "gpt-4-turbo", "claude-3-5-sonnet-20241022", "claude-3-opus-20240229", "gemini-pro"]
statuses = %w[completed completed completed failed]
...
50.times do |i|
  ...
  RAAF::Eval::Models::EvaluationSpan.create!(
    ...
    span_data: {
      ...
      "output_messages" => if output_content
                             [
