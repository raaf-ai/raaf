            ...
            content_tag(:div, class: "flex-shrink-0") do
              content_tag(:svg, class: "w-5 h-5 text-green-500", fill: "currentColor", viewBox: "0 0 20 20") do
                content_tag(:path, nil, fill_rule: "evenodd",
                                        d: "M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z", clip_rule: "evenodd")
              end
            end
          when "failed"
            content_tag(:div, class: "flex-shrink-0") do
              content_tag(:svg, class: "w-5 h-5 text-red-500", fill: "currentColor", viewBox: "0 0 20 20") do
                content_tag(:path, nil, fill_rule: "evenodd",
                                        d: "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z", clip_rule: "evenodd")
              end
            end
          when "running"
            content_tag(:div, class: "flex-shrink-0") do
              content_tag(:svg, class: "w-5 h-5 text-blue-500 animate-spin", fill: "none", stroke: "currentColor",
                                viewBox: "0 0 24 24") do
                content_tag(:circle, nil, class: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor",
                                          stroke_width: "4") +
            ...
            content_tag(:div, class: "flex-shrink-0") do
              content_tag(:svg, class: "w-5 h-5 text-gray-500", fill: "none", stroke: "currentColor",
                                viewBox: "0 0 24 24") do
                content_tag(:path, nil, stroke_linecap: "round", stroke_linejoin: "round", stroke_width: "2",
