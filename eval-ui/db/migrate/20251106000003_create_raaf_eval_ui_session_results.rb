  ...
  def change
    create_table :raaf_eval_ui_session_results do |t|
      t.references :raaf_eval_ui_session, null: false, foreign_key: true,
                                          index: { name: "index_session_results_on_session_id" }
      t.references :raaf_eval_ui_session_configuration, null: false, foreign_key: true,
                                                        index: { name: "index_session_results_on_config_id" }
      ...
      t.index %i[raaf_eval_ui_session_id status], name: "index_session_results_on_session_id_and_status"
