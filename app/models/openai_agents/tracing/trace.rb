...
module OpenAIAgents
  module Tracing
    ...
    #   OpenAIAgents::Tracing::Trace.recent.limit(10)
    #
    # @example Find traces by workflow
    #   OpenAIAgents::Tracing::Trace.by_workflow("Order Processing")
    #
    # @example Find failed traces
    #   OpenAIAgents::Tracing::Trace.failed
    #
    # @example Get trace performance summary
    #   trace = OpenAIAgents::Tracing::Trace.find_by(trace_id: "trace_abc123")
    #   trace.performance_summary
    class TraceRecord < ActiveRecord::Base
      self.table_name = "openai_agents_tracing_traces"

      # Associations
      has_many :spans, primary_key: :trace_id, foreign_key: :trace_id,
                       class_name: "OpenAIAgents::Tracing::SpanRecord", dependent: :destroy
