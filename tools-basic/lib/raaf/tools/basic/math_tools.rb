    ...
    module Basic
      ...
      class MathTools
        ...
        class << self
          ...
          #
          # @return [RubyAIAgentsFactory::FunctionTool] Unit conversion tool
          #
          def convert_units
            RubyAIAgentsFactory::FunctionTool.new(
          ...
          #
          # @return [RubyAIAgentsFactory::FunctionTool] Random generator tool
          #
          def generate_random
            RubyAIAgentsFactory::FunctionTool.new(
          ...
          #
          # @return [RubyAIAgentsFactory::FunctionTool] Statistical analysis tool
          #
