...
class ResearchPrompt < RAAF::DSL::Prompts::Base
  ...
  optional :sources, default: ["academic", "industry"]
...
prompt3 = RAAF::DSL::Prompt.resolve("analysis.md.erb",
  ...
  data: { q1: 1000000, q2: 1200000, q3: 1100000, q4: 1500000 },
...
class YamlPromptResolver < RAAF::DSL::PromptResolver
  ...
  def interpolate(text, context)
    ...
    text.gsub(/\{\{(\w+)\}\}/) { |m| context[$1.to_sym] || m }
  end
end
...
[:research, :support, :analysis].each do |scenario|
