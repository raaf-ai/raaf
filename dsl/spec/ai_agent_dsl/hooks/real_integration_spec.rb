...
RSpec.describe "Real Hooks Integration", :integration do
  ...
  describe "real agent execution with hooks" do
    ...
    it "verifies hooks provide correct agent information" do
      ...
      AiAgentDsl::Hooks::RunHooks.on_agent_end do |_agent, result|
    ...
    it "verifies multiple hooks of same type execute in order" do
      ...
      AiAgentDsl::Hooks::RunHooks.on_agent_end { |_agent, _result| execution_log << "global_end_1" }
      AiAgentDsl::Hooks::RunHooks.on_agent_end { |_agent, _result| execution_log << "global_end_2" }
