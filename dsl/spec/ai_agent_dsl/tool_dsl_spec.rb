...
RSpec.describe AiAgentDsl::ToolDsl do
  let(:tool_class) do
    Class.new(AiAgentDsl::Tools::Base) do
  ...
  describe "class methods" do
    describe "#tool_name" do
      ...
      it "defaults to class name when not set" do
        unnamed_class = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
        end
    ...
    describe "#description" do
      ...
      it "returns nil when not set" do
        class_without_desc = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
        end
    ...
    describe "#version" do
      ...
      it "defaults to 1.0.0 when not set" do
        class_without_version = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
        end
    ...
    describe "#category" do
      ...
      it "returns nil when not set" do
        class_without_category = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
        end
    ...
    describe "#parameter" do
      ...
      it "supports nested object parameters" do
        nested_class = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
        ...
        expect(params[:filters][:properties]).to include(
          date_range:     { type: :string, required: false, default: nil, enum: ["today", "week", "month"] },
    ...
    describe "#tool_configuration" do
      ...
      it "omits nil values" do
        minimal_class = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
          tool_name "minimal"
        end
  ...
  describe "instance methods" do
    describe "#tool_definition" do
      ...
      it "handles tools without required parameters" do
        optional_class = Class.new(AiAgentDsl::Tools::Base) do
          include AiAgentDsl::ToolDsl
  ...
  describe "NestedParameterBuilder" do
    let(:builder) { AiAgentDsl::ToolDsl::NestedParameterBuilder.new }
    ...
    it "builds nested parameter structures" do
      ...
      expect(builder.properties).to eq({
        ...
        active: { type: :boolean, required: false, default: true, description: "Is active" }
      })
    end
  end
  ...
  describe "edge cases" do
    it "handles empty tool configuration" do
      empty_class = Class.new(AiAgentDsl::Tools::Base) do
        include AiAgentDsl::ToolDsl
      end
    ...
    it "handles parameters with enum options" do
      enum_class = Class.new(AiAgentDsl::Tools::Base) do
        include AiAgentDsl::ToolDsl

        tool_name "enum_tool"
        parameter :mode, type: :string, enum: ["fast", "accurate", "balanced"]
      end

      instance = enum_class.new
      mode_param = instance.tool_definition[:function][:parameters][:properties][:mode]

      expect(mode_param).to include(enum: ["fast", "accurate", "balanced"])
    end
  end
end
