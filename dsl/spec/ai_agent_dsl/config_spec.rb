...
RSpec.describe AiAgentDsl::Config, :with_temp_files do
  let(:test_config) do
    {
      "defaults"    => {
        "global" => {
  ...
  describe "class methods" do
    ...
    describe ".max_turns_for" do
      ...
      it "falls back to default max_turns" do
        ...
        expect(max_turns).to eq(3) # Default from AiAgentDsl.configuration
      end
    end
    ...
    describe ".model_for" do
      ...
      it "falls back to default model" do
        ...
        expect(model).to eq("gpt-4o") # Default from AiAgentDsl.configuration
      end
    end
    ...
    describe ".temperature_for" do
      ...
      it "falls back to default temperature" do
        ...
        expect(temperature).to eq(0.7) # Default from AiAgentDsl.configuration
      end
    end
    ...
    describe "configuration loading" do
      ...
      context "with missing config file" do
        it "returns empty configuration" do
          AiAgentDsl.configure { |c| c.config_file = "nonexistent.yml" }
      ...
      context "with invalid YAML" do
        it "returns empty configuration" do
          ...
          AiAgentDsl.configure { |c| c.config_file = invalid_config_path }
