...
RSpec.describe RAAF::DSL::Hooks::RunHooks do
  before do
  ...
  describe "hook registration" do
    ...
    it "registers hooks for all supported event types" do
      described_class.on_agent_start { |agent| } # rubocop:disable Lint/EmptyBlock
      described_class.on_agent_end { |agent, result| } # rubocop:disable Lint/EmptyBlock
      described_class.on_handoff { |from, to| } # rubocop:disable Lint/EmptyBlock
      described_class.on_tool_start { |agent, tool, params| } # rubocop:disable Lint/EmptyBlock
      described_class.on_tool_end { |agent, tool, params, result| } # rubocop:disable Lint/EmptyBlock
      described_class.on_error { |agent, error| } # rubocop:disable Lint/EmptyBlock
  ...
  describe "hook validation" do
    ...
    it "raises error when both method and block provided" do
      expect do
        described_class.on_agent_start(:test_method) { |agent| } # rubocop:disable Lint/EmptyBlock
