...
RSpec.describe RAAF::DSL::Agents::Base do
  let(:agent_instance) do
    described_class.new(context_variables: context_variables, processing_params: processing_params)
  end
  ...
  describe "configuration-only base class behavior" do
    ...
    it "raises NotImplementedError for abstract configuration methods" do
      abstract_methods = %w[agent_name build_instructions build_schema]
  ...
  describe "#create_agent" do
    context "creates OpenAI agent with DSL configuration" do
      ...
      it "creates OpenAI agent instance with configuration" do
        allow(agent_instance).to receive_messages(agent_name: "TestAgent", build_instructions: "Test instructions",
                                                  model_name: "gpt-4o", tools: [], handoffs: [], response_format: { type: "json" }, max_turns: 3)
      ...
      it "passes DSL configuration to OpenAI agent" do
        allow(agent_instance).to receive_messages(agent_name: "TestAgent", build_instructions: "Test instructions",
                                                  model_name: "gpt-4o", tools: [{ name: "test_tool" }], handoffs: [], response_format: { type: "json" }, max_turns: 5)
  ...
  describe "abstract configuration methods" do
    describe "#agent_name" do
      it "raises NotImplementedError" do
        ...
        end.to raise_error(NotImplementedError, "Subclasses must implement #agent_name")
      end
    end
    ...
    describe "#build_instructions" do
      it "raises NotImplementedError" do
        expect do
          agent_instance.build_instructions
        end.to raise_error(NotImplementedError,
                           "Subclasses must implement #build_instructions")
      end
    end
    ...
    describe "#build_schema" do
      it "raises NotImplementedError" do
        expect do
          agent_instance.build_schema
        end.to raise_error(NotImplementedError, "Subclasses must implement #build_schema")
      end
    end
  end
  ...
  describe "utility methods" do
    ...
    describe "#document_description" do
      ...
      it "returns empty string when description missing" do
        ...
        agent = described_class.new(context_variables: context_without_description,
    ...
    describe "#format_list" do
      it "joins array of document types" do
        params_with_array = { formats: %w[Text PDF Spreadsheet] }
  ...
  describe "subclass implementation" do
    ...
    let(:concrete_instance) do
      concrete_agent_class.new(context_variables: context_variables, processing_params: processing_params)
    end
  ...
  describe "#run - delegation to openai-agents-ruby" do
    ...
    it "delegates execution to openai-agents-ruby" do
      ...
      stub_const("RAAF::Runner", runner_class)
