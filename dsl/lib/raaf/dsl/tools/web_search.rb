...
#   end
#
class AiAgentDsl::Tools::WebSearch < Base
  # Valid search context size options
  VALID_CONTEXT_SIZES = ["low", "medium", "high"].freeze
  ...
  def validate_options!
    if options[:search_context_size] && !VALID_CONTEXT_SIZES.include?(options[:search_context_size])
      raise ArgumentError,
