...
# hooks that will be passed to the OpenAI Agents SDK for execution.
# The DSL collects hook definitions but does not execute them - all
# execution is delegated to the OpenAI Agents framework.
#
# @example Basic usage
...
#   end
#
#   AiAgentDsl::Hooks::RunHooks.on_agent_start :log_agent_start
#
# @example Multiple handlers in order
#   AiAgentDsl::Hooks::RunHooks.on_agent_start :first_handler
#   AiAgentDsl::Hooks::RunHooks.on_agent_start :second_handler
#   AiAgentDsl::Hooks::RunHooks.on_agent_start { |agent| puts "Third handler" }
#
module AiAgentDsl::Hooks::RunHooks
  ...
  class << self
    ...
    # @yieldparam to_agent [OpenAIAgents::Agent] The agent receiving control
    #
