...
module AiAgentDsl
  module Generators
    ...
    # 1. An agent class that inherits from AiAgentDsl::Agents::Base
    # 2. A corresponding prompt class that inherits from AiAgentDsl::Prompts::Base
    #
    # ## File Structure
    ...
    class AgentGenerator < Rails::Generators::NamedBase
      ...
      #
      # The agent class inherits from AiAgentDsl::Agents::Base and includes
      # the AiAgentDsl::AgentDsl module for DSL functionality.
      ...
      #
      # The prompt class inherits from AiAgentDsl::Prompts::Base and provides
