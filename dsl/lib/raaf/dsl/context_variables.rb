...
#
# @example Basic usage
#   context = AiAgentDsl::ContextVariables.new(session_id: "123", user_tier: "premium")
#   updated = context.update(request_analyzed: true, priority: "high")
#   puts updated.get(:priority) # => "high"
#
# @example With debugging
#   context = AiAgentDsl::ContextVariables.new({ user: "john" }, debug: true)
#   context.update(step: "analysis") # Logs the update
#
# @since 0.2.0
#
class AiAgentDsl::ContextVariables
  ...
  #
  # @example
  #   original = AiAgentDsl::ContextVariables.new(step: 1)
