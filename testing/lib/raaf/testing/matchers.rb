...
module RAAF
  module Testing
    ...
    module Matchers
      ...
      ##
      # Matcher for negative sentiment analysis
      #
      RSpec::Matchers.define :have_negative_sentiment do
        ...
        failure_message do |result|
          sentiment = extract_sentiment(result)
          "expected agent response to have negative sentiment, but got: #{sentiment.inspect}"
        end
      ...
      ##
      # Matcher for neutral sentiment analysis
      #
      RSpec::Matchers.define :have_neutral_sentiment do
        ...
        failure_message do |result|
          sentiment = extract_sentiment(result)
          "expected agent response to have neutral sentiment, but got: #{sentiment.inspect}"
        end
