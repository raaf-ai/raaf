...
RSpec.describe "Statistical Matchers" do
  ...
  describe "be_statistically_significant matcher" do
    ...
    it "handles empty samples" do
      ...
      expect(result).not_to be_statistically_significant
    end
    ...
    context "when negated" do
      it "provides clear negated failure message" do
        ...
        begin
          expect(significantly_different_result).not_to be_statistically_significant
        rescue RSpec::Expectations::ExpectationNotMetError => e
  ...
  describe "have_effect_size matcher" do
    ...
    it "handles empty samples" do
      ...
      expect(result).not_to have_effect_size
    end

    context "when negated" do
      it "provides clear negated failure message" do
        expect(large_effect_result).not_to have_effect_size
      rescue RSpec::Expectations::ExpectationNotMetError => e
  ...
  describe "have_confidence_interval matcher" do
    ...
    it "handles empty samples" do
      ...
      expect(result).not_to have_confidence_interval.within(90, 110)
    end
    ...
    context "when negated" do
      it "provides clear negated failure message" do
        expect(narrow_ci_result).not_to have_confidence_interval.within(90, 110)
      rescue RSpec::Expectations::ExpectationNotMetError => e
