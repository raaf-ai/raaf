...
RSpec.describe RAAF::Rails::Continuous::EvaluatorsController, type: :request do
  describe "GET /raaf/continuous/evaluators" do
    it "returns a list of available evaluators" do
      ...
      get continuous_evaluators_path
    ...
    it "returns JSON when requested" do
      ...
      get continuous_evaluators_path, as: :json
      expect(response).to have_http_status(:success)
      expect(JSON.parse(response.body)).to eq(evaluators.map(&:stringify_keys))
    end
  end

  describe "GET /raaf/continuous/evaluators/:id" do
    context "when evaluator exists" do
      it "returns evaluator details" do
        ...
        get continuous_evaluator_path("test_evaluator")
        expect(response).to have_http_status(:success)
      end
      ...
      it "returns JSON when requested" do
        ...
        get continuous_evaluator_path("test_evaluator"), as: :json
        expect(response).to have_http_status(:success)
    ...
    context "when evaluator does not exist" do
      it "returns not found" do
        ...
        get continuous_evaluator_path("nonexistent"), as: :json
