...
require "redcarpet"
require "nokogiri"
require "raaf_guides/markdown/renderer"
require "raaf_guides/markdown/epub_renderer"
...
module RailsGuides
  class Markdown
    ...
    def extract_raw_header_and_body
      return unless /^-{40,}$/.match?(@raw_body)
    ...
    def generate_description
      ...
      @description = @description.delete_prefix(@heading.text) if @heading
    end
      ...
      return unless @body.present?
        ...
        document = html_fragment(@body).tap do |doc|
          ...
          doc.children.each do |node|
            next unless /^h[2-5]$/.match?(node.name)
    ...
    def generate_index
      return unless @headings_for_index.present?
