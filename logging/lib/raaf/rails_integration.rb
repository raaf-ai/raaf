    ...
    module RailsIntegration
        ...
        def setup_activejob_integration
          ActiveJob::Base.class_eval do
            around_perform do |job, block|
              RubyAIAgentsFactory::Logging.info(
                "ActiveJob started",
              ...
              RubyAIAgentsFactory::Logging.error(
                "ActiveJob failed",
                job_class: job.class.name,
                job_id: job.job_id,
                error: e.message,
      ...
      class EnhancedRailsLoggerAdapter < RailsLoggerAdapter
        ...
        def current_trace_id
          ...
          return nil unless defined?(RubyAIAgentsFactory::Tracing)

          RubyAIAgentsFactory::Tracing.current_trace&.trace_id
        end
      end
    end
  end
...
if defined?(Rails) && Rails.application&.config
  Rails.application.config.to_prepare do
    RubyAIAgentsFactory::Logging::RailsIntegration.setup!
  end
end
